...
INSERT INTO conductor (
    nombre, apellido, dni, edad, descripcion_conductor, created_at, updated_at, id_usuario
      ...
      ('Marta','Quispe','55555555',28,'Conduce con prudencia', '2025-09-30 10:30:00', NULL,
       (SELECT id_usuario FROM usuario WHERE email='conductora@uniride.test'));

-- ========== VEHICULOS ==========
INSERT INTO vehiculo
(placa, soat, modelo, marca, capacidad, descripcion_vehiculo, id_conductor)
VALUES
    ('ABC-123', TRUE, 'Yaris',  'Toyota',  4, 'Sedán compacto, aire acondicionado', (SELECT id_conductor FROM conductor WHERE dni='44444444')),
    ('XYZ-987', TRUE, 'Accent', 'Hyundai', 4, 'Buen maletero, mantenimiento al día', (SELECT id_conductor FROM conductor WHERE dni='55555555'));
...
INSERT INTO pago (
    ...
    (nextval('pago_seq'), 8, '2025-10-05', '08:10:00', 0.50, 'YAPE', 'COMPLETADO',
     (SELECT id_solicitud_viaje FROM solicitud_viaje ORDER BY id_solicitud_viaje ASC LIMIT 1)
    ),
    (nextval('pago_seq'), 10, '2025-10-05', '17:50:00', 0.60, 'TARJETA_DEBITO', 'EN_PROGRESO',
