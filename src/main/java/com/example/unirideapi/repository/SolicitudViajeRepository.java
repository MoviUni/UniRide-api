...
public interface SolicitudViajeRepository extends JpaRepository<SolicitudViaje, Long> {
    ...
    @Query("""
            SELECT s.idSolicitudViaje, s.estadoSolicitud, r.origen, r.destino, r.fechaSalida, r.horaSalida, r.tarifa, r.asientosDisponibles, c.nombre, c.apellido, s.ruta.idRuta, c.vehiculo.color, c.vehiculo.placa, c.vehiculo.modelo
